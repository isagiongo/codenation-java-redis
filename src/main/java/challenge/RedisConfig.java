...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, RestaurantRedis> restRedisTemplate(RedisConnectionFactory connectionFactory){
        return redisTemplateBuilder(connectionFactory, RestaurantRedis.class);
    }

    @Bean
    public RedisTemplate<String, NeighborhoodRedis> neigRedisTemplate(RedisConnectionFactory connectionFactory){
